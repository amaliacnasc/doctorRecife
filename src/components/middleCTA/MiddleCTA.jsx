    ...
    <div >
        <div className='row mt-3 container-cta'>
            <div className='col-lg-6 container-especialidade '>
              <h2 className='text-uppercase text-white'>Encontre a especialidade certa para você</h2>
              <ul>
              ...
              <p className='text-white fonte lupa'> <i  className=" lupa bi bi-search"></i>Veja a clínica mais próxima</p>
            </div>
